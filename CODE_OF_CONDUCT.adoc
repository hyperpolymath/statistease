...
Statistikles a harassment-free experience for everyone, regardless of
...
. The Statistikles maintainers will review the report
...
The Statistikles maintainers will follow these guidelines in determining
consequences:
...
* Appeals are reviewed by a different Statistikles maintainers member
than the original
...
* Open a
https://github.com/hyperpolymath/statistikles/discussions[Discussion]
