...
[arabic]
. Navigate to
https://github.com/hyperpolymath/statistikles/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/statistikles+`) and all its code
...
https://github.com/hyperpolymath/statistikles/security/advisories[Security
Advisories]
...
When using Statistikles, we recommend:
...
|*General questions*
|https://github.com/hyperpolymath/statistikles/discussions[GitHub
Discussions]
...
_Thank you for helping keep Statistikles and its users safe._ 🛡️
