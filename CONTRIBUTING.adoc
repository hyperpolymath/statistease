...
git clone https://github.com/hyperpolymath/statistikles.git cd
statistikles
...
toolbox create statistikles-dev toolbox enter statistikles-dev # Install
...
statistikles/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
